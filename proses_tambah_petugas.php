...
if($_POST){
    ...
    if(empty($nama_petugas)){
        ...
        echo "<script>alert('password tidak boleh kosong');location.href='tambah_pertugas.php';</script>";
    } elseif(empty($level)){
        echo "<script>alert('level tidak boleh kosong');location.href='tambah_pertugas.php';</script>";
    } else {
        include "koneksi.php";
